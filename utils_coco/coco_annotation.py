#-------------------------------------------------------#
#   Used to process the COCO dataset, generate txt files for training based on json files
#-------------------------------------------------------#
import json
import os
...
#-------------------------------------------------------#
#   Paths to COCO training set and validation set images
#-------------------------------------------------------#
train_datasets_path     = "coco_dataset/train2017"
val_datasets_path       = "coco_dataset/val2017"

#-------------------------------------------------------#
#   Paths to COCO training set and validation set labels
#-------------------------------------------------------#
